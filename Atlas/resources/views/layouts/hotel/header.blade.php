                                        ...
                                        <nav>
                                            <ul class="at-home-navbar-nav ht-home-navbar-nav">
                                                ...
                                                @foreach ($menu_items as $key => $item)
                                                    @if ($key < 2)
                                                        @if ($item == 'Hotel')
                                                            <li><a class="at-home-nav-link {{ request()->routeIs('hotel.home') ? 'active' : '' }}" href="{{ route('hotel.home') }}">{{ get_phrase('Hotel') }}</a></li>
                                                        @elseif($item == 'Real-Estate')
                                                            <li><a class="at-home-nav-link {{ request()->routeIs('real-estate.home') ? 'active' : '' }}" href="{{ route('real-estate.home') }}">{{ get_phrase('Real Estate') }}</a></li>
                                                        @elseif($item == 'Car')
                                                        ...
                                                        @elseif($item == 'Restaurant')
                                                            <li><a class="at-home-nav-link {{ request()->routeIs('restaurant.home') ? 'active' : '' }}" href="{{ route('restaurant.home') }}">{{ get_phrase('Restaurant') }}</a></li>
                                                        @elseif($item == 'Beauty')
                                                        ...
                                                        <ul class="first-sub-menu">
                                                            @foreach ($menu_items as $key => $item)
                                                                @if ($key >= 2)
                                                                    ...
                                                                    @elseif($item == 'Restaurant')
                                                                        <li><a class="atn-sub-nav-link {{ request()->routeIs('restaurant.home') ? 'active' : '' }}" href="{{ route('restaurant.home') }}">{{ get_phrase('Restaurant') }}</a></li>
                                                                    @elseif($item == 'Beauty')
