        ...
        <div class="row row-28 mb-90 mt-3">
            ...
            <div class="col-lg-8">
                <div class="aGdescription">
                    ...
                    <ul>
                        @php 
                           $Beauty = App\Models\BeautyListing::where('user_id', $users->id)->count();
                           $Hotel = App\Models\HotelListing::where('user_id', $users->id)->count();
                           $Restaurant = App\Models\RestaurantListing::where('user_id', $users->id)->count();
                           $Realestate = App\Models\RealEstateListing::where('user_id', $users->id)->count();
