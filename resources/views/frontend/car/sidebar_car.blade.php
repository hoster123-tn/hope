    ...
    <ul class="sidebar-accordion">
        <li class="sidebar-accordion-li">
            ...
            <ul class="sidebar-accordion-menu sidebar-menu-active nBlock" id="categoryList">
                @foreach ($categories as $index => $category)
                    @php
                        $categoryCount = App\Models\CarListing::where('category', $category->id)->count();
                    @endphp
        ...
        <li class="sidebar-accordion-li">
            ...
            <ul class="sidebar-accordion-menu" id="carTypeList">
                @foreach ($car_types as $index => $type)
                    @php
                        $typeCount = App\Models\CarListing::where('car_type', $type->id)->count();
                    @endphp
                 <li class="{{ $index >= 6 ? 'hidden' : '' }}">
        ...
        <li class="sidebar-accordion-li">
            ...
            <ul class="sidebar-accordion-menu" id="carModelList">
                ...
                @php
                    $typeCount = App\Models\CarListing::where('model', $model->id)->count();
                @endphp
             <li class="{{ $index >= 6 ? 'hidden' : '' }}">
        ...
        <li class="sidebar-accordion-li">
            ...
            <ul class="sidebar-accordion-menu" id="carBrandList">
                ...
                @php
                    $typeCount = App\Models\CarListing::where('brand', $brand->id)->count();
                @endphp
             <li class="{{ $index >= 6 ? 'hidden' : '' }}">
        ...
        <li class="sidebar-accordion-li">
            ...
            <ul class="sidebar-accordion-menu" id="carYearList">
                ...
                @php
                    $typeCount = App\Models\CarListing::where('year', $year)->count();
                @endphp
             <li class="{{ $index >= 6 ? 'hidden' : '' }}">
        ...
        <li class="sidebar-accordion-li">
            ...
            <ul class="sidebar-accordion-menu" id="carColorsList">
                ...
                @php
                    $typeCount = App\Models\CarListing::where('exterior_color', $color->id)->count();
                @endphp
             <li class="{{ $index >= 6 ? 'hidden' : '' }}">
