                                    ...
                                    <nav class="header-nav">
                                        <ul class="header-nav-list">
                                            ...
                                            @foreach ($menu_items as $key => $item)
                                                @if ($key < 2)
                                                    @if ($item == 'Hotel')
                                                        <li><a class="first-a {{ request()->routeIs('hotel.home') ? 'active' : '' }}" href="{{ route('hotel.home') }}">{{ get_phrase('Hotel') }}</a></li>
                                                    @elseif($item == 'Real-Estate')
                                                        <li><a class="first-a {{ request()->routeIs('real-estate.home') ? 'active' : '' }}" href="{{ route('real-estate.home') }}">{{ get_phrase('Real Estate') }}</a></li>
                                                    @elseif($item == 'Car')
                                                        <li><a class="first-a {{ request()->routeIs('car.home') ? 'active' : '' }}" href="{{ route('car.home') }}">{{ get_phrase('Car') }}</a></li>
                                                    @elseif($item == 'Restaurant')
                                                        <li><a class="first-a {{ request()->routeIs('restaurant.home') ? 'active' : '' }}" href="{{ route('restaurant.home') }}">{{ get_phrase('Restaurant') }}</a></li>
                                                    @elseif($item == 'Beauty')
